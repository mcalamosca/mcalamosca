export const historyCards = [
  ...
  },
  {
    title: "The Beginning",
    summary:
      "The history of Davide Sauce begins in 1927 when the Fazi family immigrated from Italy and brought the tradition of making sauce with them.",
    paragraphs: [
      "The history of Davide Sauce begins in 1927,  when the Fazi family immigrated from Italy and brought the tradition of making sauce with them. 60 years later Davide, their grandson, continued the tradition of purity and simplicity and made it available in a jar for people to enjoy.",
    ],
    expand: false,
    images: [
      {
      ...
      },
      {
        ...
        alt: "Davide, 1995 at his production facility",
      },
      {
        src: "assets/images/history/micah-bottling-sauce-age-7.jpg",
        alt: "Micah Bottling Sauce Age 7",
      },
      {
        src: "assets/images/history/micah-cleaning-up-kitchen-age-2.jpg",
        alt: "Micah Cleaning Up Kitchen Age 2",
      },
      {
        src: "assets/images/history/Micah bottling sauce age 7.jpg",
        alt: "Micah Bottling Sauce Age 7",
      ...
      {
        src: "assets/images/history/olive press senigallia 2000.jpg",
        alt: "Olive Press Senigallia 2000",
      },
      {
  ...
  },
  {
    ...
    images: [
      ...
      {
        src: "assets/images/history/Fred & kids 1995.jpg",
        alt: "Fred & kids 1995",
      },
      {
        src: "assets/images/history/Fred My T Shirt Seated.jpg",
        alt: "Fred Davide T Shirt",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: "assets/images/history/Micah.JPG",
        alt: "Micah sampling at Whole Foods Market",
      },
      {
        src: "assets/images/history/nonno-micah-theo.jpg",
        alt: "Davide, Micah, and his grandson Theo",
      },
      {
        src: "assets/images/history/nonno-theo.jpg",
        alt: "Davide and his grandson Theo",
      },
    ],
  },
];
