export const healthCards = [
  ...
  },
  {
    ...
    content:
      "Most pasta sauces contain an average range of 400-500 mg of sodium per serving. Our sauce significantly lowers this number to just 220 mg per serving, aligning with health guidelines advocating for cardiovascular health.",
  ...
  },
  {
    ...
    content:
      "Unlike many sauces that rely on tomato paste made from lower quality tomatoes and add sugars or corn syrup to compensate for taste, our sauce uses fresh carrots. These provide a naturally sweet flavor without the need for added sugars, supporting a healthier diet and reducing risks associated with high sugar intake. The sweetness in our sauce is from fresh carrots, an ingredient rarely found in other sauces.",
